...
```graphql
{
  accountTimeSeriesStats(
    timeFrame: Month
    account: "7ekbc8F72Zm4KKQwbgSe7UTaiprHb8nkmbA2ti5hKoCX"
    type: "access"
    blockchain: "solana"
  ) {
    series {
  ...
  implements SolanaIndexerWorkerDomainI, IndexerWorkerDomainWithStats
{
  ...
  async onNewAccount(config: AccountIndexerConfigWithMeta<MarinadeFinanceAccountInfo>): Promise<void> {
